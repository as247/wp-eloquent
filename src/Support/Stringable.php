...
use Closure;
use As247\WpEloquent\Support\Traits\Conditionable;
use As247\WpEloquent\Support\Traits\Macroable;
use As247\WpEloquent\Support\Traits\Tappable;
...
class Stringable implements JsonSerializable
{
    ...
    {
        return new static(asdb_class_basename($this->value));
    }
    ...
    public function split($pattern, $limit = -1, $flags = 0)
    {
        if (filter_var($pattern, FILTER_VALIDATE_INT) !== false) {
            return asdb_collect(mb_str_split($this->value, $pattern));
        }
    ...
    {
        return asdb_collect(sscanf($this->value, $format));
    }
    ...
    {
        return asdb_collect(Str::ucsplit($this->value));
    }
     ...
     *
     * @return \As247\WpEloquent\Support\HtmlString
     */
