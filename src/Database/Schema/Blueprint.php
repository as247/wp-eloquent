...
class Blueprint
{
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \As247\WpEloquent\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \As247\WpEloquent\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \As247\WpEloquent\Database\Eloquent\Model|string  $model
