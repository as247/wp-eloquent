...
use As247\WpEloquent\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     *
     * @var \As247\WpEloquent\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \As247\WpEloquent\Support\Fluent[]
     */
    protected $commands = [];
    ...
    {
        return wpe_collect($this->commands)->filter(function ($command) use ($names) {
    ...
    {
        return wpe_collect($this->commands)->contains(function ($command) {
     ...
     *
     * @return \As247\WpEloquent\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \As247\WpEloquent\Support\Fluent|\As247\WpEloquent\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \As247\WpEloquent\Database\Schema\ColumnDefinition
     */
