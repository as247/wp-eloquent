...
class FactoryBuilder
{
    ...
    public function create(array $attributes = [])
    {
        ...
        if ($results instanceof Model) {
            $this->store(wpe_collect([$results]));

            $this->callAfterCreating(wpe_collect([$results]));
        } else {
            $this->store($results);
     ...
     *
     * @param  \As247\WpEloquent\Support\Collection  $results
     * @return void
     */
    ...
    {
        if ($this->amount === null) {
            return wpe_tap($this->makeInstance($attributes), function ($instance) {
                $this->callAfterMaking(wpe_collect([$instance]));
            });
        }
     ...
     *
     * @param  \As247\WpEloquent\Support\Collection  $models
     * @return void
     */
