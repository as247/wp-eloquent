...
use As247\WpEloquent\Database\Eloquent\ModelNotFoundException;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \As247\WpEloquent\Database\Eloquent\Builder|null  $query
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \As247\WpEloquent\Support\Collection|\As247\WpEloquent\Database\Eloquent\Model
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \As247\WpEloquent\Database\Eloquent\Model|\As247\WpEloquent\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \As247\WpEloquent\Database\Eloquent\Model|\As247\WpEloquent\Database\Eloquent\Collection
     *
     * @throws \As247\WpEloquent\Database\Eloquent\ModelNotFoundException
     */
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return wpe_tap($this->query->paginate($perPage, $columns, $pageName, $page), function ($paginator) {
    ...
    public function simplePaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return wpe_tap($this->query->simplePaginate($perPage, $columns, $pageName, $page), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    ...
    {
        return Str::camel(Str::pluralStudly(wpe_class_basename($this->getParent())));
    }
     ...
     *
     * @param  \As247\WpEloquent\Support\Collection|array  $models
     * @param  array  $pivotAttributes
     * @return array
     */
