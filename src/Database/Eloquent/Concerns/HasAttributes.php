...
trait HasAttributes
{
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        return wpe_tap($relation->getResults(), function ($results) use ($method) {
    ...
    {
        return wpe_tap($this->getArrayAttributeByKey($key), function (&$array) use ($path, $value) {
    ...
    {
        static::$mutatorCache[$class] = wpe_collect(static::getMutatorMethods($class))->map(function ($match) {
