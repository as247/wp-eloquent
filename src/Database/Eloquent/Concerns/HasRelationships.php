...
use As247\WpEloquent\Database\Eloquent\Relations\BelongsTo;
...
use As247\WpEloquent\Database\Eloquent\Relations\HasOne;
use As247\WpEloquent\Database\Eloquent\Relations\HasOneThrough;
use As247\WpEloquent\Database\Eloquent\Relations\MorphMany;
use As247\WpEloquent\Database\Eloquent\Relations\MorphOne;
use As247\WpEloquent\Database\Eloquent\Relations\MorphTo;
use As247\WpEloquent\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
     ...
     * @return \As247\WpEloquent\Database\Eloquent\Relations\HasOneThrough
     */
     ...
     *
     * @param  \As247\WpEloquent\Database\Eloquent\Builder  $query
     * @param  \As247\WpEloquent\Database\Eloquent\Model  $farParent
     * @param  \As247\WpEloquent\Database\Eloquent\Model  $throughParent
     ...
     *
     * @param  \As247\WpEloquent\Database\Eloquent\Builder  $query
     * @param  \As247\WpEloquent\Database\Eloquent\Model  $child
     * @param  string  $foreignKey
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \As247\WpEloquent\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     *
     * @param  string  $related
     * @param  \As247\WpEloquent\Database\Eloquent\Model|null  $instance
     * @return string
     */
