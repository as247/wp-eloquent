...
namespace As247\WpEloquent\Database\Migrations;

use As247\WpEloquent\Console\OutputStyle;
use As247\WpEloquent\Contracts\Events\Dispatcher;
use As247\WpEloquent\Database\ConnectionResolverInterface as Resolver;
use As247\WpEloquent\Database\Events\MigrationEnded;
use As247\WpEloquent\Database\Events\MigrationsEnded;
use As247\WpEloquent\Database\Events\MigrationsStarted;
use As247\WpEloquent\Database\Events\MigrationStarted;
...
class Migrator
{
     ...
     *
     * @var \As247\WpEloquent\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @var \As247\WpEloquent\Console\OutputStyle
     */
    protected $output;
     ...
     *
     * @param  \As247\WpEloquent\Database\Migrations\MigrationRepositoryInterface  $repository
     * @param  \As247\WpEloquent\Database\ConnectionResolverInterface  $resolver
     * @param  \As247\WpEloquent\Filesystem\Filesystem  $files
     * @param  \As247\WpEloquent\Contracts\Events\Dispatcher|null  $dispatcher
     * @return void
     */
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = false)
    {
        ...
        $migrations = wpe_collect($migrations)->map(function ($m) {
     ...
     *
     * @return \As247\WpEloquent\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \As247\WpEloquent\Filesystem\Filesystem
     */
     ...
     *
     * @param  \As247\WpEloquent\Console\OutputStyle  $output
     * @return $this
     */
     ...
     *
     * @param  \As247\WpEloquent\Contracts\Database\Events\MigrationEvent $event
     * @return void
     */
