...
class Builder
{
     ...
     * @param  string  $as
     * @return \As247\WpEloquent\Database\Query\Builder|static
     *
     ...
     *
     * @param  \As247\WpEloquent\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\As247\WpEloquent\Database\Query\Builder|string  $column
    ...
    {
        return wpe_collect($this->onceWithColumns(Arr::wrap($columns), function () {
    ...
    public function paginate($perPage = 15, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        $results = $total ? $this->forPage($page, $perPage)->get($columns) : wpe_collect();
    ...
    {
        return wpe_tap(clone $this, function ($clone) use ($properties) {
    ...
    {
        return wpe_tap(clone $this, function ($clone) use ($except) {
